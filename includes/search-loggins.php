                    ...
                    <tbody>
                        <?php foreach ($recent_logs as $log): ?>
                            <?php
                                ...
                                $user_agent    = get_post_meta($log->ID, 'user_agent', true); // New User Agent meta
                            ?>
                            <tr>
                                <td><?php echo esc_html($created_date); ?></td>
                                <td>
                                ...
                                <td><?php echo esc_html($user_agent); ?></td> <!-- Display User Agent -->
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
...
function snn_log_redirect($redirect_from, $redirect_to) {
    ...
    if ($log_id) {
        ...
        update_post_meta($log_id, 'user_agent', snn_get_user_agent()); // Store User Agent
