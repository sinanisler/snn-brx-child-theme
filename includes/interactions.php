...
function snn_enable_lenis_callback() {
    ...
    <div class="lenis-settings">
        <input type="checkbox" id="enable_lenis" name="snn_other_settings[enable_lenis]" value="1" <?php checked(1, $enabled); ?>>
        <label for="enable_lenis">
            <strong><?php _e('Enable Lenis Smooth Scroll', 'snn'); ?></strong>
        </label>
        ...
        <div class="lenis-config <?php echo $enabled ? '' : 'lenis-disabled'; ?>">
            ...
            <div class="lenis-field">
                <label>
                    ...
                    <input type="number" class="lenis-input-small" step="0.1" min="0.1" max="5" name="snn_other_settings[lenis_duration]" value="<?php echo isset($options['lenis_duration']) ? esc_attr($options['lenis_duration']) : '1.2'; ?>">
                </label>
            ...
            <div class="lenis-field">
                <label>
                    ...
                    <input type="number" class="lenis-input-small" step="0.01" min="0.01" max="1" name="snn_other_settings[lenis_lerp]" value="<?php echo isset($options['lenis_lerp']) ? esc_attr($options['lenis_lerp']) : '0.1'; ?>">
                </label>
            ...
            <div class="lenis-field">
                <label>
                    ...
                    <input type="number" class="lenis-input-small" step="0.1" min="0.1" max="5" name="snn_other_settings[lenis_wheelMultiplier]" value="<?php echo isset($options['lenis_wheelMultiplier']) ? esc_attr($options['lenis_wheelMultiplier']) : '1'; ?>">
                </label>
            ...
            <div class="lenis-field">
                ...
                <p class="description"><?php _e('Smooth the scroll initiated by wheel events. Default: enabled', 'snn'); ?></p>
            </div>

            <!-- Advanced Settings Accordion -->
            <details class="lenis-accordion">
                <summary class="lenis-field lenis-summary">
                ...
                <div class="lenis-accordion-content">
                    <div class="lenis-field">
                        <label>
                            ...
                            <select name="snn_other_settings[lenis_orientation]" class="lenis-select">
                                <option value="vertical" <?php selected(isset($options['lenis_orientation']) ? $options['lenis_orientation'] : 'vertical', 'vertical'); ?>>Vertical</option>
                                <option value="horizontal" <?php selected(isset($options['lenis_orientation']) ? $options['lenis_orientation'] : 'vertical', 'horizontal'); ?>>Horizontal</option>
                            </select>
                        </label>
                    ...
                    <div class="lenis-field">
                        <label>
                            ...
                            <select name="snn_other_settings[lenis_gestureOrientation]" class="lenis-select">
                                <option value="vertical" <?php selected(isset($options['lenis_gestureOrientation']) ? $options['lenis_gestureOrientation'] : 'vertical', 'vertical'); ?>>Vertical</option>
                                <option value="horizontal" <?php selected(isset($options['lenis_gestureOrientation']) ? $options['lenis_gestureOrientation'] : 'vertical', 'horizontal'); ?>>Horizontal</option>
                                <option value="both" <?php selected(isset($options['lenis_gestureOrientation']) ? $options['lenis_gestureOrientation'] : 'vertical', 'both'); ?>>Both</option>
                            </select>
                        </label>
                    ...
                    <div class="lenis-field">
                        <label>
                            ...
                            <input type="number" class="lenis-input-small" step="0.001" min="0.001" max="1" name="snn_other_settings[lenis_syncTouchLerp]" value="<?php echo isset($options['lenis_syncTouchLerp']) ? esc_attr($options['lenis_syncTouchLerp']) : '0.075'; ?>">
                        </label>
                    ...
                    <div class="lenis-field">
                        <label>
                            ...
                            <input type="number" class="lenis-input-small" step="0.1" min="0.1" max="5" name="snn_other_settings[lenis_touchMultiplier]" value="<?php echo isset($options['lenis_touchMultiplier']) ? esc_attr($options['lenis_touchMultiplier']) : '1'; ?>">
                        </label>
                    ...
                    <div class="lenis-field">
                        <label>
                            ...
                            <input type="number" class="lenis-input-small" step="0.1" min="0.1" max="5" name="snn_other_settings[lenis_touchInertiaExponent]" value="<?php echo isset($options['lenis_touchInertiaExponent']) ? esc_attr($options['lenis_touchInertiaExponent']) : '1.7'; ?>">
                        </label>
                    ...
                    <div class="lenis-field">
                        <label>
                            ...
                            <select name="snn_other_settings[lenis_easing]" class="lenis-select">
                                <option value="default" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'default'); ?>>Default (Custom)</option>
                                <option value="linear" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'linear'); ?>>Linear</option>
                                <option value="easeInQuad" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'easeInQuad'); ?>>Ease In Quad</option>
                                <option value="easeOutQuad" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'easeOutQuad'); ?>>Ease Out Quad</option>
                                <option value="easeInOutQuad" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'easeInOutQuad'); ?>>Ease In Out Quad</option>
                                <option value="easeInCubic" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'easeInCubic'); ?>>Ease In Cubic</option>
                                <option value="easeOutCubic" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'easeOutCubic'); ?>>Ease Out Cubic</option>
                                <option value="easeInOutCubic" <?php selected(isset($options['lenis_easing']) ? $options['lenis_easing'] : 'default', 'easeInOutCubic'); ?>>Ease In Out Cubic</option>
                            </select>
                        </label>
                        <p class="description"><?php _e('Easing function for scroll animation. Default: custom exponential', 'snn'); ?></p>
                    </div>
                </div>
            </details>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const enableCheckbox = document.getElementById('enable_lenis');
                const configDiv = document.querySelector('.lenis-config');

                if (enableCheckbox && configDiv) {
                    enableCheckbox.addEventListener('change', function() {
                        if (this.checked) {
                            configDiv.classList.remove('lenis-disabled');
                        } else {
                            configDiv.classList.add('lenis-disabled');
                        }
                    });
                }
            });
