...
/**
 * Add AI overlay to block editor footer
 */
function snn_add_block_editor_ai_overlay() {
    ...
    <button class="snn-block-ai-button" id="snn-block-ai-open-button">AI</button>
    ...
    (function() {
        ...
        const openButton = document.getElementById('snn-block-ai-open-button');
...
add_action('admin_footer', 'snn_add_block_editor_ai_overlay');
