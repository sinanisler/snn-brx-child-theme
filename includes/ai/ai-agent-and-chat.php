...
class SNN_Chat_Overlay {
    ...
    public function get_token_count() {
        return absint( get_option( 'snn_ai_agent_token_count', 20000 ) );
    }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    <strong><?php echo esc_html__('Default:', 'snn'); ?></strong> 20000 | <strong><?php echo esc_html__('Recommended range:', 'snn'); ?></strong> 20000 or more
                                </p>
                            </td>
                        </tr>
