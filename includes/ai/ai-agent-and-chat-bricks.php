...
<button class="snn-bricks-quick-action-btn" data-message="Design a luxury real estate homepage for 'Noir Properties'. Section 1 — Full-viewport hero with a moody dark overlay on a penthouse photo, large serif heading 'Live Above the Ordinary', thin subheading, and two CTAs (Explore Listings, Book a Tour); thin gold (#C9A44A) accent line under the heading. Section 2 — Horizontal marquee-style stats band: 850+ Properties Sold · $2.4B in Sales · 14 Global Cities · 98% Client Satisfaction, dark charcoal background. Section 3 — 3-column featured listings grid with property photo cards, each card has address, price in gold, bedroom/bath icons, and a hover overlay with a View Details button. Section 4 — Full-width 2-column split: left is a dramatic interior photo, right has a dark background with a serif heading 'Curated for the Discerning Buyer', paragraph, and a ghost-style CTA button. Section 5 — Testimonials section with 3 quote cards on a warm off-white background, client name, title, and star rating in gold. Section 6 — Dark footer CTA 'Schedule a Private Consultation' with an inline email form and a subtle background texture. Use palette: near-black #0D0D0D, warm white #F5F2EE, gold #C9A44A.">
Luxury Real Estate</button>

<button class="snn-bricks-quick-action-btn" data-message="Design a premium skincare brand homepage for 'Luminos'. Section 1 — Full-viewport hero split into a 60/40 grid: left side has a soft blush gradient background, large editorial serif heading 'Skin That Speaks', italic subheading 'Science-backed. Nature-inspired.', and two buttons (Shop Now, Our Ritual); right side has a large product bottle photo with a soft drop shadow. Section 2 — Horizontal ingredient highlights band: 5 ingredients listed with a small icon and 1-line benefit each (Vitamin C, Retinol, Hyaluronic Acid, Niacinamide, Peptides), clean white background. Section 3 — 3-column product cards with product photo, name, skin concern tag, price, and Add to Bag button; subtle peach background. Section 4 — 2-column editorial section: left has a model close-up photo with a soft blur border, right has a bold serif heading 'The 3-Step Ritual', numbered steps with short descriptions. Section 5 — Full-width before/after transformation section with 2 side-by-side image pairs and a centered heading 'Real Results. Real People.' Section 6 — Press logos band ('As Seen In' + Vogue, Elle, Harper's Bazaar logos). Section 7 — Dark footer CTA 'Start Your Skin Journey' with email subscribe input. Palette: blush #F7E8E0, charcoal #1C1C1C, gold #D4A574, white #FEFEFE.">
Skincare Brand</button>

<button class="snn-bricks-quick-action-btn" data-message="Design a bold SaaS product homepage for 'Flowmatic' — an AI workflow automation tool. Section 1 — Dark hero with a radial gradient background (deep navy to near-black), centered layout, small pill badge 'Now in Beta', massive heading 'Automate Everything. Ship Faster.', subheading about connecting tools without code, two CTA buttons (Start Free, Watch Demo), and a floating product UI screenshot below with a glow effect. Section 2 — Social proof logos band: 'Trusted by teams at' + 6 company logos in white/gray on a slightly lighter dark background. Section 3 — 3-column features grid on a very dark background: each card has a colorful gradient icon, bold feature title, and 2-line description; cards have subtle border glow on hover. Section 4 — Full-width product showcase: left column with 3 toggleable use-case tabs (Marketing, Engineering, Operations) with a description, right side shows a large UI screenshot; electric blue accent. Section 5 — Pricing section with 3 plan cards (Starter, Pro, Enterprise), highlighted middle card with a glowing border, feature lists, and CTA buttons. Section 6 — Testimonials from CTOs/founders, dark card style, avatar photo, company name. Section 7 — Bottom CTA banner 'Your workflows are waiting' with a gradient background and Get Started Free button. Palette: #050B18 background, #1A2744 cards, #3B82F6 electric blue, #10B981 green accents, white text.">
SaaS Product</button>

<button class="snn-bricks-quick-action-btn" data-message="Design a high-end personal portfolio for a creative director named 'Elena Vasquez'. Section 1 — Asymmetric hero: black background, left side has stacked large text ELENA / VASQUEZ in massive condensed font (different weights per line), Creative Director subtitle in thin italic, two small links (Work ↓, Contact); right side has a high-contrast black and white portrait photo at full height. Section 2 — Scrolling marquee ticker in white on black: BRANDING · EDITORIAL · ART DIRECTION · CAMPAIGN · IDENTITY · MOTION · STRATEGY ·, repeated, bold caps. Section 3 — Featured projects grid: 2 large cards on top (full bleed project images with overlay title and category), 3 smaller cards below — hover reveals a dark overlay with project name and arrow. Section 4 — 2-column about section: right side has a square photo of her at work, left side has a bold heading 'I make brands feel inevitable.', a paragraph bio, a list of 5 clients (Nike, Spotify, Bottega Veneta, Apple, Dior). Section 5 — Services offered: 4 horizontal rows, full-width, each row has a large number (01–04), service name in large type, and short description; alternating white/off-white rows with a thin top border. Section 6 — Awards & press band: D&AD, Cannes Lions, Webby, The One Show logos. Section 7 — Dark contact footer with a massive 'Let's Work.' heading, email address, social links. Palette: pure black #000, white #FFF, warm off-white #F5F3EF, single accent #FF3D00 orange-red for hover states.">
Creative Portfolio</button>

<button class="snn-bricks-quick-action-btn" data-message="Design a premium fitness & performance coaching homepage for 'FORM' by coach Marcus Reid. Section 1 — Full-viewport dark hero: background is a dramatic gym photo with a 70% dark overlay, left-aligned layout, overline text 'Elite Performance Coaching', massive bold heading 'Built Different.', subtext about 1-on-1 coaching for serious athletes, two CTAs (Apply Now — filled red, See Results — ghost); a subtle red (#E11D48) gradient strip along the left edge. Section 2 — Horizontal stats bar on red background: 1,200+ Athletes Trained · 8 Years Experience · 94% Hit Their Goal · Featured in Men's Health; white bold numbers, thinner label text. Section 3 — 3-column program cards: each card has a dark background, program name (Strength, Fat Loss, Performance), bullet list of included features, duration, price, and an Apply CTA; middle card highlighted with red border. Section 4 — 2-column transformation section: left has a before/after image pair with overlay labels, right has heading 'Real People. Real Results.', 3 short testimonial quotes with client name and result achieved (e.g., '-22kg in 16 weeks'). Section 5 — Full-width 'How It Works' section on off-white: 4 numbered steps in a horizontal row with icon, step number in large red, bold step title, short description. Section 6 — About coach section: 2-column, left has a serious high-contrast coach portrait, right has bio, credentials, and a quote in large italic. Section 7 — Dark bottom CTA: 'Ready to Build Your Best Body?' with Apply for Coaching button and note '— Limited spots available'. Palette: #0A0A0A near-black, #E11D48 red, #F5F5F5 off-white, white text.">
Fitness Coaching</button>
