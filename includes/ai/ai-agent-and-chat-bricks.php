        ...
        <div id="snn-bricks-chat-overlay" class="snn-bricks-chat-overlay" style="display: none;">
            <div class="snn-bricks-chat-container">
                ...
                <div class="snn-bricks-chat-quick-actions">
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a UI/UX Architect. Design a single-page luxury real estate landing page by defining the exact Element/Widget sequence for my visual builder. Stick to the Architectural Zen aesthetic. Global Styles: Background: Alabaster (#f0f0f0). Typography: Headers in Cinzel, Body in Manrope. Accents: Use Gold Bronze (#c2b280) only for 1px borders and button outlines. Page Structure (Create all 5 sections in order): HERO SECTION: * Element: Full-height Background Video Container. Overlay: 10% Charcoal tint. Heading: Small, centered text. Uppercase. 4px letter spacing. THE GALLERY (Apartment Finder): * Element: Filterable Portfolio/Grid Widget. Controls: Pill-shaped toggle buttons for Bedrooms (1BR, 2BR, Penthouse). Layout: 3-column masonry with Gold Bronze 1px borders. THE PLAN (Interactive Section): * Element: Custom SVG/Hotspot Widget. Interaction: Map room coordinates to tooltips showing Square Footage. Style: Minimalist line-art only (no solid fills). AMENITIES: * Element: Icon Box Grid. Icons: Use thin-line style (Lucide) for Wifi, Pool, and Car. Styling: Charcoal text, high padding (80px) between icons. LOCATION: * Element: Google Maps Widget. Filter: Apply a Grayscale or Silver saturation filter (-100). Marker: Replace default pin with a custom Gold Bronze dot. Instruction: Do not write code. Describe the settings, spacing, and widget types required for each section to ensure the full page is built">Real Estate</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a Creative Director. Design a full-page digital agency portfolio by defining the specific Widget Stack for my visual builder. Maintain the Bento-Grid Chaotic aesthetic throughout the entire build. Global Styles: Base Theme: Dark Mode. Background Off-Black (#18181b) and Light Gray (#27272a). Typography: Headers in Syne (Extra Bold), Body in DM Sans. Accents: Hot Pink (#db2777) for buttons and Acid Green (#a3e635) for badges. Page Structure (Build every section in this sequence): HERO MARQUEE SECTION: Element: Full-width Text Marquee Widget. Content: WE BUILD BRANDS in massive Syne font. Background: Set a Video Background (Showreel) behind the scrolling text with a 40% dark overlay. THE BENTO WORK GRID: Element: Masonry/Bento Grid Widget. Cell Layout: Mix of Square, 2x1 Wide, and 1x2 Tall aspect ratios. Content: Video Thumbnails that auto-play. Interaction: Apply a Focus effect where hovering one card adds a 50% blur to all other grid items. SERVICE TICKER DIVIDER: Element: Slim Marquee/Ticker Widget. Styling: Background color Acid Green, Text color Off-Black. Speed: Fast horizontal scroll between the Grid and Footer. THE GIANT FOOTER: Element: Section Container set to 80vh height. Primary Widget: Massive Heading (LETS TALK) centered vertically and horizontally. Interaction: Mouse-follow effect where the text color shifts from White to Hot Pink based on cursor position. Socials: Icon List widget using Lucide (Instagram, Dribbble) in the bottom-right corner. Instruction: Do not provide code. Describe the sequence of widgets and their specific settings to ensure the agent builds the entire page from top to bottom">Agency</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a Conversion Designer. Design a complete wellness sales page by defining the specific Widget Sequence for my visual builder. Maintain the Soft Focus aesthetic for every element. Global Styles: Background: Cream (#fdfbf7) with Lavender (#d8defd) soft radial gradients in the corners. Typography: Headers in Nunito (Rounded), Body in Quicksand. Shapes: Set Global Corner Radius to 30px or Maximum Rounded. No sharp edges. Page Structure (Build all 4 sections in this order): FROSTED HEADER & HERO: Header Element: Sticky Navigation with Backdrop-Blur (Glassmorphism) effect. Hero Element: Split-row Container. Content: Center-aligned headline on the left; Image widget on the right with a floating/breathing animation. Accents: Use Sage Green (#84a98c) for the primary Call-to-Action button. CURRICULUM ACCORDION: Element: Vertical Accordion Widget. Style: Frameless design with soft Lavender background fills for the active tab. Content: 5 Modules with smooth expand/collapse transitions. TESTIMONIAL WALL: Element: Masonry Grid or Card Carousel. Style: White background cards with very soft, diffused Drop Shadows (Blur: 40px, Opacity: 10%). Detail: Rounded corners (20px) on every testimonial card. ICON BENEFITS: Element: 3-Column Feature Grid. Icons: Use Lucide Icons (Sun, Moon, Heart) in Sage Green. Styling: Place icons inside circular containers with a light Lavender tint. Instruction: Do not write code. Detail the widget sequence and the specific blur/rounding settings to ensure the agent outlines the full sales page from start to finish">Wellness</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a Fintech UI Designer. Design a full-page cryptocurrency exchange landing page by defining the specific Widget Stack for my visual builder. Maintain the Glassmorphism Finance aesthetic across all sections. Global Styles: Background: Deep Space (#000000) with subtle Blurple (#6366f1) glow orbs placed randomly in the background. Typography: Headers in Rajdhani (Technical), Data/Numbers in Share Tech Mono. Accents: Neon Mint (#34d399) for all buttons, trend lines, and success states. Page Structure (Build all 5 sections in this order): HERO & LIVE TICKER: Ticker Element: Slim horizontal marquee placed at the top of the page. Content: Scrolling coin prices in Neon Mint. Hero Element: Centered column. Background: Video container playing a 3D token loop. Headline: Large Rajdhani text with 0.1em tracking. GLASS FEATURE GRID: Element: 3-Column Card Layout (Wallet, Swap, Stake). Card Style: Translucent background, Backdrop-Blur (12px), and a 1px White border set to 10% opacity. Icons: Lucide Icons (Lock, Activity, Bitcoin) styled in Neon Mint. STAKING CALCULATOR (Data Section): Element: Centered Content Box with the same Glassmorphism style. Typography: Use Share Tech Mono for all numerical inputs and APY displays to feel like a terminal. GLOWING ROADMAP: Element: Vertical Timeline Widget. Style: Central line set to a Blurple-to-Mint gradient. Milestone Dots: Active items must have a Box-Shadow (Glow) effect in Neon Mint. SECURE FOOTER: Element: Minimalist 4-column footer. Background: Solid Gunmetal (#18181b) to ground the page. Socials: Lucide Icons for community links. Instruction: Do not write code. Detail the sequence of widgets and specific blur/opacity settings to ensure the agent outlines the entire landing page from top to bottom">Crypto</button>
                </div>
