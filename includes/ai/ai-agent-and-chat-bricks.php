        ...
        <div id="snn-bricks-chat-overlay" class="snn-bricks-chat-overlay" style="display: none;">
            <div class="snn-bricks-chat-container">
                ...
                <div class="snn-bricks-chat-quick-actions">
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a UI Architect. Create a 4-section 'Architectural Zen' landing page using the 'snn/generate-bricks-content' ability. Execute these sections: HERO: A 'section' with minHeight '100vh'. Layout: 2-column grid. Left has a 'heading' (font: Cinzel, size '80', weight '300') and 'text-basic'. Right has a full-height 'image' with objectFit 'cover'. STATS: A dark '#1a1a1a' 'section'. A 3-column grid of 'blocks'. Each has a 'heading' (color: '#c2b280', size '56') and 'text-basic' (color: '#ffffff', content: 'Square Feet'). PROJECTS: A 'section' with background '#f0f0f0'. Use a 2-column grid where images have aspectRatio '1/1' and borderRadius '0'. Headings should be centered below images. CTA: A centered 'container' with maxWidth '800'. Background '#c2b280'. White 'heading' and a 'button' with borderRadius '0' and backgroundHover '#1a1a1a'. Rule: Use raw numbers for spacing (no 'px'). Ensure all grids include gridTemplateColumns:mobile_landscape '1fr'">Real Estate</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a Creative Director. Design a 'Bento-Box' Agency landing page. Generate this 4-section sequence: HERO: Dark mode '#000000'. Massive 'heading' (font: Syne, size '120', color: '#a3e635'). Below it, a 3-column flex 'block' with small icons and text. BENTO GRID: A 'section' containing a grid with 3 cards. Card 1: gridColumn 'span 2', background '#db2777'. Cards 2 & 3: background '#18181b'. All cards: borderRadius '30' and padding '40'. SERVICES: A 'section' with a sticky sidebar. Left 'block' is position 'sticky', top '100'. Right 'block' contains a long list of 'heading' + 'text-basic' pairs for scrolling. FOOTER CTA: Background '#a3e635'. Text color '#000000'. Centered 'heading' size '90'. Large 'button' with borderRadius '100' and padding '30 60'. Rule: Focus on gap values of '30' and ensure _opacity is used for subtext.">Agency</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a Conversion Specialist. Build a 'Soft-Focus' Wellness landing page with 4 sections: HERO: Background '#fdfbf7'. Flex column layout, alignItems 'center'. 'heading' (size '72', color: '#4a5d4e'). 'image' with borderRadius '1000' (Circle) and breathing animation. BENEFITS: 3-column grid. Each 'block' has background 'rgba(255,255,255,0.5)', _backdropFilter 'blur(10px)', and borderRadius '40'. Use Sage Green icons. TESTIMONIAL: A 'section' with background '#d8defd'. Centered 'container' maxWidth '700'. 'text-basic' (size '24', textAlign 'center', lineHeight '1.6'). PRICING: A 'section' with 2 cards. Card styling: _boxShadow '0 20px 40px rgba(0,0,0,0.05)', background '#ffffff', padding '60', borderRadius '40'. Rule: All buttons must have borderRadius '50'. Use fontSize:mobile_landscape overrides for all headings.">Wellness</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Act as a Fintech Lead. Design a 'Cyber-Crypto' landing page. Execute 4 sections: HERO: Background '#000000'. Centered content. 'heading' with letterSpacing '-3' and Neon Mint color '#34d399'. Add a 'button' with _boxShadow '0 0 20px #34d399'. MARKET TICKER: A slim 'section' with padding '20 0'. Use a flex row with justifyContent 'space-between'. Use 'text-basic' (font: 'Share Tech Mono', color: '#34d399'). FEATURES: A 4-column grid of 'blocks'. Each block has a 1px border (_border), background 'rgba(255,255,255,0.03)', and borderRadius '12'. SECURITY: Split layout 'section'. Left: 'image' (Security Shield). Right: 'heading' + 'text-basic' + 'list'. Accent color '#6366f1' (Blurple). Rule: Use _gridGap '40'. Ensure all 'image' elements have _objectFit 'cover' and aspectRatio defined">Fintech</button>
                </div>
