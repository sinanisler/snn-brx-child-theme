    ...
    public function render_overlay() {
        ...
        <div id="snn-bricks-chat-overlay" class="snn-bricks-chat-overlay" style="display: none;">
            <div class="snn-bricks-chat-container">
                ...
                <div class="snn-bricks-chat-quick-actions">
                    <button class="snn-bricks-quick-action-btn" data-message="Create a modern homepage for a flower shop">Flower Shop</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Design a hero section with image">Hero Section</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Add a services section">Services Section</button>
                </div>
        ...
        (function($) {
            ...
            function addToolbarButton() {
                ...
                if (!toolbar) {
                    console.error('Bricks toolbar not found');
                    return;
                }
