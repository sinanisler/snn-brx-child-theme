        ...
        <div id="snn-bricks-chat-overlay" class="snn-bricks-chat-overlay" style="display: none;">
            <div class="snn-bricks-chat-container">
                ...
                <div class="snn-bricks-chat-quick-actions">
                    <button class="snn-bricks-quick-action-btn" data-message="Design an immersive, luxury real estate development landing page using Tailwind CSS. Follow these visual and technical guidelines: Aesthetic & Vibe: 'Architectural Zen.' Rigid grids, fine lines, and wide panoramic imagery. Minimalist to the extreme to let the property photos speak. Typography: Use 'Cinzel' for headers (classic, roman-inspired) and 'Manrope' for modern utility text. Color Palette: Primary: Gold Bronze (#c2b280) for subtle lines and button borders. Secondary: Charcoal (#333333) for text and overlays. Base: Alabaster (#f0f0f0) and White (#ffffff). Key Sections: Hero Section: A full-screen background video slider with slow cross-fades. The headline is small, centered, and uppercase with wide letter spacing. Apartment Finder: A distinctive grid where users can filter by 'Bedrooms' or 'Floor' using pill-shaped toggle buttons. Interactive Floorplan: A scalable vector graphic (SVG) section where hovering over a room highlights it and shows square footage in a tooltip. Neighborhood Map: A stylized Mapbox/Google Maps integration using a grayscale theme with custom gold map markers. Technical Implementation: Use Lucide Icons for amenities (Wifi, Pool, Car).">Real Estate</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Design a grid-heavy, visually rich portfolio homepage for a creative digital agency using Tailwind CSS. Follow these visual and technical guidelines: Aesthetic & Vibe: 'Bento-Grid Chaotic.' A masonry-style layout that feels packed but organized. High energy, heavy use of video thumbnails and hover effects. Typography: Use 'Syne' for quirky, artistic headlines and 'DM Sans' for body text. Color Palette: Primary: Hot Pink (#db2777) for hover states and bold interaction points. Secondary: Acid Green (#a3e635) for tags and badges. Base: Off-Black (#18181b) and Light Gray (#27272a). Key Sections: Hero Section: Just a massive, screen-filling typography marquee scrolling left-to-right saying 'WE BUILD BRANDS', overlayed by the agency showreel. The Work Grid: A dense grid of cards of varying aspect ratios (square, tall, wide). Hovering a card dims all others and plays a video preview. Service Ticker: A yellow bar with scrolling black text separating sections. Footer: A massive footer occupying 80% of the viewport height with a giant 'LET’S TALK' link that changes color on mouse movement. Technical Implementation: Use Lucide Icons for social links (Instagram, Dribbble).">Agency</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Design a soothing, accessible sales page for a meditation and wellness course using Tailwind CSS. Follow these visual and technical guidelines: Aesthetic & Vibe: 'Soft Focus.' Heavy use of gaussian blur, pastel gradients, and rounded shapes. Nothing sharp. Typography: Use 'Nunito' for rounded, friendly headings and 'Quicksand' for body text. Color Palette: Primary: Sage Green (#84a98c) for primary buttons. Secondary: Lavender (#d8defd) for background gradients. Base: Cream (#fdfbf7) and White (#ffffff). Key Sections: Header: Transparent background that becomes a solid frosted glass (backdrop-blur-md) on scroll. Hero Section: A soft gradient background with a center-aligned headline. An image of a person meditating floats on the right with a 'breathing' animation CSS effect. Curriculum Accordion: A clean list of course modules where clicking the header expands the details smoothly. Testimonial Wall: A masonry grid of 'tweets' and reviews with soft drop shadows and rounded corners. Technical Implementation: Use Lucide Icons for calming elements (Sun, Moon, Heart).">Wellness</button>
                    <button class="snn-bricks-quick-action-btn" data-message="Design a sleek, dark-mode landing page for a new cryptocurrency exchange platform using Tailwind CSS. Follow these visual and technical guidelines: Aesthetic & Vibe: 'Glassmorphism Finance.' Deep layers, blurs, and metallic gradients. It should feel weightless and secure. Typography: Use 'Rajdhani' for a squared, technical look in headers and 'Share Tech Mono' for data/numbers. Color Palette: Primary: Neon Mint (#34d399) for positive trends and primary actions. Secondary: Blurple (Blue-Purple) (#6366f1) for gradients and background orbs. Base: Deep Space (#000000) and Gunmetal (#18181b). Key Sections: Hero Section: Minimal text centered. The background features a 3D spinning coin or token loop (using a video or CSS animation). Live Ticker: A horizontal bar just below the header showing scrolling live prices of major coins. Card Glass Effect: Feature cards (Wallet, Swap, Stake) using backdrop-filter: blur(12px) and a thin white border with 10% opacity. Roadmap: A vertical timeline with a glowing line connecting milestones. Active milestones pulsate. Technical Implementation: Use Lucide Icons for crypto concepts (Bitcoin, Activity, Lock).">Crypto</button>
                </div>
