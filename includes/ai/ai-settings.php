...
function snn_render_ai_settings() {
    ...
    $default_presets = [
        ...
        ['name' => 'SEO',      'prompt' => 'Generate SEO-optimized title and meta description. Format: Title: [title here] | Description: [description here]. Keep title under 60 characters and description under 160 characters.'],
    ];
