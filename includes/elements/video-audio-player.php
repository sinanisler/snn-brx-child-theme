...
class SNN_Video_Player_Element extends Element {
	...
	public function render() {
		...
		echo "<style>
			...
			#" . esc_attr($root_id) . " .snn-progress-tooltip { position: absolute; background-color: #1f2937; color: var(--text-color); font-size: 11.25px; /* 0.75rem * 15 */ border-radius: 3.75px; /* 0.25rem * 15 */ padding: 3.75px 7.5px; /* 0.25rem * 15, 0.5rem * 15 */ top: -30px; /* -2rem * 15 */ pointer-events: none; opacity: 0; transition: opacity 0.2s; white-space: nowrap; transform: translateX(-50%); }
